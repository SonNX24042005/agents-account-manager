...
#  Sử dụng:
#    Cài đặt:        curl -fsSL https://raw.githubusercontent.com/SonNX24042005/agents-account-manager/main/install.sh | bash
#    Gỡ cài đặt:    curl -fsSL https://raw.githubusercontent.com/SonNX24042005/agents-account-manager/main/install.sh | bash -s -- uninstall
#    Cập nhật:       curl -fsSL https://raw.githubusercontent.com/SonNX24042005/agents-account-manager/main/install.sh | bash -s -- update
#    Cài đặt lại:    curl -fsSL https://raw.githubusercontent.com/SonNX24042005/agents-account-manager/main/install.sh | bash -s -- reinstall
#    Trạng thái:     curl -fsSL https://raw.githubusercontent.com/SonNX24042005/agents-account-manager/main/install.sh | bash -s -- status
# ==============================================================================
