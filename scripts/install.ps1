...
#  Sử dụng:
#    Cài đặt:        irm https://raw.githubusercontent.com/SonNX24042005/agents-account-manager/main/scripts/install.ps1 | iex
#    Gỡ cài đặt:    .\scripts\install.ps1 -Action uninstall [-Purge]
#    Cập nhật:       .\scripts\install.ps1 -Action update
# ==============================================================================
...
function Show-Help {
    ...
    Write-Host "  .\scripts\install.ps1 [-Action <lệnh>] [-Purge] [-KeepData]"
    Write-Host ""
